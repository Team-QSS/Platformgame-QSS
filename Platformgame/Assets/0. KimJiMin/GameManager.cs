...
public class GameManager : MonoBehaviour
{
    ...
    private Vector3 CameraPositionY; //카메라 위쪽의 Y좌표값을 가져오는 역할
    ...
    void Start()
    {
        CameraPositionY = Camera.main.ScreenToWorldPoint(new Vector3(Screen.width,Screen.height, 0));
        MissileRespawn = new Vector3(Random.Range(-6, 6), CameraPositionY.y,0);
